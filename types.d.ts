 ...
 */
export type TumblrClientCallback = (err: Error | null, resp: Record<string, any> | null, response?: IncomingMessage | null | undefined) => void;
...
export type NpfContentBlock = AudioBlock | ImageBlock | LinkBlock | PaywallBlock | TextBlock | VideoBlock;
...
export interface BlogPosts<This> {
    ...
    /** @deprecated Use promises instead of callbacks */
    (this: This, blogIdentifier: string, params: BlogPostsParams, callback: TumblrClientCallback): undefined;
}
